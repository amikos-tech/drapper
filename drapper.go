...
func RegisterEventHandler(ctx context.Context, appdID string, pubsubName string, topic string, route string, resourcePath string, handler func(ctx context.Context, e *common.TopicEvent) (retry bool, err error)) (cancel func(), err error) {
	...
	go startDaprSidecar(ctx, appdID, 8886, 3500, 50001, resourcePath, daprStarted)
